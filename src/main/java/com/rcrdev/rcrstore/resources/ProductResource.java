...
import com.rcrdev.rcrstore.dto.ProductDTO;
import com.rcrdev.rcrstore.resources.utils.URL;
import com.rcrdev.rcrstore.services.ProductService;

@RestController //to inform that the class is a Rest Controller
@RequestMapping(value="/products") //the endpoint
