...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> validation(MethodArgumentNotValidException e, HttpServletRequest request) {
		...
		for (FieldError x : e.getBindingResult().getFieldErrors()) { //a excecao MethodArgumentNotValidException retorna os erros e é assim que sao acessados.Cada erro da exceccao é adicionado na lista de erros
